...
export const TodoList = ({ todos, searchTerm, onEdit, onDelete }) => {
    ...
    <>
      {filteredTodos.length === 0 ? (
        ...
        filteredTodos.map((todo, index) => (
          <div key={todo.id} className="todo-item flex justify-between items-center mb-4 cursor-pointer bg-gray-50 p-2 rounded-md">
